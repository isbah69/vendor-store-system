...
.logout-btn:hover {
  ...
  <span style="font-weight:600;">
    <?php echo htmlspecialchars($_SESSION['username'] ?? 'User'); ?>
          ...
          <li>
            <a href="#" data-toggle="control-sidebar"><i class="fa fa-address-card"></i></a>
          </li>
        </ul>
      </div>
    </nav>
                      ...
                      while ($row = mysqli_fetch_assoc($result)) 
                      {
                         ...
                         echo "</td>";
                          ...
                          if ($_role === 'admin' || $_role === 'manager' || $_role === 'accountant') {
                              echo "<a href='edit_returns.php?id=".$row["return_item_id"]."' class='btn btn-success btn-sm'>Edit</a> ";
                          } else {
                              echo "<button class='btn btn-success btn-sm' disabled title='Access Denied' style='opacity:0.5;cursor:not-allowed;'>Edit</button> ";
                          }
                          if ($_role === 'admin') {
                              echo "<a href='delete_returns_item.php?id=".$row["return_item_id"]."' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure?');\">Delete</a>";
                          } else {
