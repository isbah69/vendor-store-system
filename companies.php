        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <?php if ($_role === 'admin' || $_role === 'manager' || $_role === 'inventory_staff'): ?>
                <a href="add_companies.php" class="btn btn-success">Add New</a>
            <?php else: ?>
                      ...
                      while ($row = mysqli_fetch_assoc($result)) 
                      {
                         ...
                         echo "<td>";
                          if ($_role === 'admin' || $_role === 'manager' || $_role === 'inventory_staff') {
                              echo "<a href='edit_company.php?id=".$row["company_id"]."' class='btn btn-success btn-sm'>Edit</a> ";
                          } else {
                              echo "<button class='btn btn-success btn-sm' disabled title='Access Denied' style='opacity:0.5;cursor:not-allowed;'>Edit</button> ";
                          }
                          if ($_role === 'admin') {
                              echo "<a href='delete_companies.php?id=".$row["company_id"]."' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure?');\">Delete</a>";
                          } else {
