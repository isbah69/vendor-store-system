                  ...
                  <?php
                    ...
                    if(mysqli_num_rows($result) > 0)
                    {
                      while ($row = mysqli_fetch_assoc($result)) 
                      {
                          ...
                          echo "</td>";
                          echo "<td>";
                          echo $row["reset_token"];
                          echo "</td>";
                          echo "<td>";
                          echo $row["token_expiry"];
                          echo "</td>";
                          echo "<td>";
                          echo $row["created_at"];
                          echo "</td>";
                           ...
                           echo "<td>";
                          if ($_role === 'admin') {
                              echo "<a href='edit_user.php?id=".$row["user_id"]."' class='btn btn-success btn-sm'>Edit</a> ";
                          } else {
                              echo "<button class='btn btn-success btn-sm' disabled title='Access Denied' style='opacity:0.5;cursor:not-allowed;'>Edit</button> ";
                          }
                          if ($_role === 'admin') {
                              echo "<a href='delete_user.php?id=".$row["user_id"]."' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure?');\">Delete</a>";
                          } else {
