          ...
          <div class="box">
           <div class="box-header">
              <?php if ($_role === 'admin' || $_role === 'manager' || $_role === 'accountant'): ?>
                  <a href="add_expense_categories.php" class="btn btn-success">Add New</a>
              <?php else: ?>
                    ...
                    if(mysqli_num_rows($result) > 0)
                    {
                      while ($row = mysqli_fetch_assoc($result)) 
                      {
                          ...
                          if ($_role === 'admin' || $_role === 'manager' || $_role === 'accountant') {
                              echo "<a href='edit_expense_categories.php?id=".$row["category_id"]."' class='btn btn-success btn-sm'>Edit</a> ";
                          } else {
                              echo "<button class='btn btn-success btn-sm' disabled title='Access Denied' style='opacity:0.5;cursor:not-allowed;'>Edit</button> ";
                          }
                          if ($_role === 'admin') {
                              echo "<a href='delete_expense_categories.php?id=".$row["category_id"]."' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure?');\">Delete</a>";
                          } else {
