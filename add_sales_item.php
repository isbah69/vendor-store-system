...
.logout-btn:hover {
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="save_sale_item.php" method="POST" role="form">
              <div class="box-body">
  ...
  <select name="sale_id" class="form-control" id="sale_id">
    ...
    $query = "SELECT sale_id FROM sales"; // your table name
  ...
  <select name="product_id" class="form-control" id="product_id">
    ...
    $query = "SELECT product_id FROM products"; // your products table
    $result = mysqli_query($con, $query);
    ...
    ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="unit_price" class="form-control" id="unit_price" placeholder="Enter Unit Price">
                </div>

                <div class="form-group">
                  <label for="total_price">Total Price</label>
                  <input type="text" name="total_price" class="form-control" id="total_price" placeholder="Enter Total Price">
                </div>

                <div class="form-group">
                  <label for="total_price">Discount</label>
                  <input type="float" name="discount" class="form-control" id="discount" placeholder="Enter Discount">
                </div>

                <div class="form-group">
                  <label for="total_price">Tax</label>
                  <input type="float" name="tax" class="form-control" id="tax" placeholder="Enter Tax">
                </div>
