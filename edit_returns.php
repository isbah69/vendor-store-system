          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
             <?php
                include_once "connection.php";
                $id = $_GET['id'];
                $sql = "select * from returns where return_id = $id";
                $result = mysqli_query($con, $sql);
                if(mysqli_num_rows($result) > 0 )
                    $row = mysqli_fetch_assoc($result);
             ?>
            <form action="update_returns.php" method="POST" role="form">
              <div class="box-body">
                <div class="form-group">
                <input type="hidden" name="return_id" value="<?php echo $row['return_id']; ?>">
                  <label for="sale_id">Sale ID</label>
                  <input type="int" name="sale_id" value="<?php echo $row['sale_id']; ?>" class="form-control" id="sale_id" placeholder="Enter Sale ID">
                </div>

                 <div class="form-group">
                  <label for="return_date">Date</label>
                  <input type="date" name="return_date" value="<?php echo $row['return_date']; ?>" class="form-control" id="return_date" placeholder="Enter  Return Date">
                </div>

                <div class="form-group">
                  <label for="return_status">Status</label>
                  <input type="text" name="return_status" value="<?php echo $row['return_status']; ?>" class="form-control" id="return_status" placeholder="Enter  Return Status">
                </div>

                <div class="form-group">
                  <label for="total_refund">Refund</label>
                  <input type="int" name="total_refund" value="<?php echo $row['total_refund']; ?>" class="form-control" id="total_refund" placeholder="Enter Total Refund">
                </div>
