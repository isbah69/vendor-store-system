...
if (!in_array($_SESSION['role'], ['admin','inventory_staff','accountant'])) {
    echo "Access Denied!";
    exit;
}
?>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <a href="add_expense.php" class="btn btn-success">Add New</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$sql = "SELECT expenses.expense_id, companies.name, expenses.amount, expenses.expense_date, expenses.description, expenses.created_at, expenses.updated_at
FROM expenses 
LEFT JOIN companies ON expenses.company_id = companies.company_id
...
if(mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>".($row["name"] ?? 'No Company')."</td>";
        ...
        echo "<td>
                <a href='edit_expenses.php?id=".$row["expense_id"]."' class='btn btn-success'>Edit</a> | 
                <a href='delete_expenses.php?id=".$row["expense_id"]."' class='btn btn-danger'>Delete</a>
              </td>";
        echo "</tr>";
    }
} else {
