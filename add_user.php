      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="save_user.php" method="POST" role="form">
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <input type="text" 
             ...
             required 
             pattern="[A-Za-z\s]+" 
             title="User name must only contain letters and spaces (no digits)">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" 
             ...
             required 
             pattern="[A-Za-z\s]+" 
             title="Role must only contain letters and spaces">
    </div>
    <div class="form-group">
      ...
      <input type="text" 
             ...
             class="form-control" 
             id="reset_token" 
             placeholder="Enter User Reset Token" 
    </div>     
    <div class="form-group">
      ...
      <input type="datetime" 
             ...
             class="form-control" 
             id="token_expiry" 
             placeholder="Enter User Token expiry" 
