      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
           <form action="save_company.php" method="POST" role="form">
  <div class="box-body">
  <!-- Company Input with Datalist -->
<div class="form-group">
    <label for="name">Company Name</label>
    <input type="text" name="name" id="name" class="form-control" list="company_list" placeholder="Enter or select company" required>
